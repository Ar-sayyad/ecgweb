      ...
      <div class="container pos-rel">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 wow fadeInLeft" data-wow-duration="0" data-wow-delay="0s">            
            <h2 class="mb-4 fw-7">
              About <span class="fw-3 txt-orange">LogZee</span>
            </h2>

            <p>Energistically utilize team driven niche markets rather than leveraged platforms. Monotonectally restore tactical "outside the box" thinking and technically sound deliverables. </p>

            <p>Compellingly develop fully researched process improvements through innovative opportunities. Credibly productize highly efficient potentialities for vertical core competencies. Quickly maintain pandemic experiences rather than low-risk high-yield processes.</p>
          </div>


          <div class="col-md-6 wow fadeInRight" data-wow-duration="0" data-wow-delay="0s">            
            <img src="<?php echo base_url();?>Theme/images/map-bg-orange.jpg" alt="">
          </div>
            ...
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 wow pulse animated" data-wow-duration="0" data-wow-delay="0.7s">
              <div class="bg-fixed pos-rel video-popup">
                ...
                <div class="zindex-fixed pos-rel">
                  <a href="#"><i class="icofont-play icofont-4x"></i></a>
                </div>
              </div>
            </div>
        </div>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">       
            <div class="col-lg-5 col-12 p-0"> 
              <img src="<?php echo base_url();?>Theme/images/why-choose-us.jpg" class="w-100" alt="">
            </div>
        ...
        <div class="row pb-4">
          ...
          <div class="col-sm-12 col-md-4 wow fadeInUp" data-wow-duration="0" data-wow-delay="0s">
            <div class="team-section-two">
              <img src="<?php echo base_url();?>Theme/images/team/team-1.jpg" alt="" class="rounded">
          ...
          <div class="col-sm-12 col-md-4 wow fadeInUp" data-wow-duration="0" data-wow-delay="0.1s">
            <div class="team-section-two">
              <img src="<?php echo base_url();?>Theme/images/team/team-2.jpg" alt="" class="rounded">
          ...
          <div class="col-sm-12 col-md-4 wow fadeInUp" data-wow-duration="0" data-wow-delay="0.2s">
            <div class="team-section-two">
              <img src="<?php echo base_url();?>Theme/images/team/team-3.jpg" alt="" class="rounded">
